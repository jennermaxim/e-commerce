...
let generateCartItems = () => {
  if (basket.length !== 0) {
        ...
        <div class="details">
          ...
          <div class="title-price-x">
              <h4 class="title-price">
                ...
                <p name="unit_prices[]" class="cart-item-price unit-price">UGX ${search.price}</p>
              </h4>
              <i onclick="removeItem(${id})" class="fa fa-trash-o"></i>
          </div>
          ...
          <h3 class="item-total-price">UGX ${item * search.price}</h3>
        </div>
      </div>
      `;
      })
    ...
    label.innerHTML = `
    <h2 class="cart-head">Cart is Empty</h2>
    <a href="index.php">
